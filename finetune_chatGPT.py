...
def train(
    ...
    output_dir: str = "./chatGPT-prompts",
    ...
    # wandb params
    wandb_project: str = "training-chatGPT-prompts",
    ...
    train=load_dataset("json", data_files="chatGPT-prompts/dataset/train.json")["train"]
    val=load_dataset("json",data_files="chatGPT-prompts/dataset/val.json")["train"]
